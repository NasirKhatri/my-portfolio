    ...
    <Box sx={{ height: "100%", display: "flex", flexDirection: "row", padding: "10px"}}>
      <Grid container alignItems="center" flexWrap="wrap-reverse" spacing={5}>
        <Grid item xs={12} md={6} style={{display: "flex", justifyContent: 'center'}}>
          ...
          <Typography variant="h3" sx={styles.h3}>Hi!</Typography>
          <Typography variant="h3" sx={styles.h3}>I'm Nasir,</Typography>
          <Typography variant="h3" sx={styles.h3}>Full-Stack Developer</Typography>
