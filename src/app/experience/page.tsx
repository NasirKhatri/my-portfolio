      ...
      <PageBody>
        ...
        <Grid item xs={12} flexGrow={1} sx={{ marginTop: "0px", maxWidth: { xs: "800px", md: "1200px" }, paddingTop: "15px" }} rowSpacing={10}>
          <>
            ...
            <Typography variant="body1" sx={{ textAlign: "justify" }}>Worked for around 1 year as a freelancer on a React based "Supply Chain" related web application key features were include warehousing, inventory monitoring, accounting and many more.</Typography>
            <Typography variant="body1">My key responsibilities was include to created responsive web pages by implimenting "Material UI" library. Creating web forms, validate them and post to the API through Async functions. And also fetching data from API and render them on the web Pages</Typography>
          ...
          <Typography variant="h5">Pak Suzuki Motors, From Sep'13 To In Progress</Typography>
